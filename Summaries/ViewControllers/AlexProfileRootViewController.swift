...
class AlexProfileRootViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        guard let secondVC = segue.destination as? AlexSecondViewController else { return }
        secondVC.user = user
    }
...
extension AlexProfileRootViewController: UITextFieldDelegate {
...
extension AlexProfileRootViewController: ThirdViewControllerDelegate {
    func initializeDelegate(dataType: UIViewController) {
    }
}

// MARK: - Extension for button configuration
extension AlexProfileRootViewController {
